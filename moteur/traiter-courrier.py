...
Codes retour : 0 = outils terminés/simulation (lire aussi ``a_verifier``),
1 = données en retard avec calculs achevés, 2 = échec technique. Une note est
...
def main():
    ...
    return 2 if statut == "echec-technique" else 1 if statut == "donnees-en-retard" else 0
