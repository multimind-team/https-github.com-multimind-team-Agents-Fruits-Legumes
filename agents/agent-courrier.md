...
sans jamais les déformer ni les deviner, et remet son inventaire au **Leader**.
...
| **Message Magasin** | Texte ou question du responsable. | Transmettre immédiatement le texte intégral au Leader pour relais vers `agent-rayon`. |
| **Fichier Douteux / Inconnu** | Format non reconnu, colonnes tronquées, dates incohérentes. | Ne jamais chercher à l'interpréter. Signaler le blocage au Leader. |
...
4. **Remise de l'inventaire au Leader :**
...
5. **Transmission au pipeline :**
   - Indiquer au Leader la commande destinée à l'agent données après contrôle. Elle peut déclencher des imports réels, ce n'est pas un simple classement :
...
- « Inventaire formel certifié (5 fichiers du jour) transmis au Leader. »
